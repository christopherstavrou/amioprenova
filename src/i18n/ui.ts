...
export const ui = {
  en: {
    ...
    news: {
      ...
      searchNoResultsTip: 'Try a different search term.',
      searchEmptyQuery: 'Enter a search term above.',
      searchBack: '← Back to News',
    },
    links: {
  ...
  bg: {
    ...
    news: {
      ...
      searchTitle: 'Търсене в новини',
      searchPlaceholder: 'Търсете новини...',
      searchResultsFor: 'резултата за',
      searchResult: 'резултат',
      searchResults: 'резултата',
      searchNoResults: 'Няма резултати за',
      searchNoResultsTip: 'Опитайте с различна дума.',
      searchEmptyQuery: 'Въведете дума за търсене.',
      searchBack: '← Обратно към новини',
    },
    links: {
